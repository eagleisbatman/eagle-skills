...
description: >
  ...
  and installs eagle-skills (15 skills + 13 agents). Use when starting a new project, onboarding to
...
6. Verify counts match expected (15 skills, 13 agents).
...
eagle-claude-md complete:
  ...
  Eagle Skills:  <15/15 skills, 13/13 agents | installed | already installed>
```
...
- Eagle-skills fully installed (15 skills + 13 agents) → skip installation
